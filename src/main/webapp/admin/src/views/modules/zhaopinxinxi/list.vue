  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="岗位类别" prop="gangweileibie">
		  <el-select  @change="gangweileibieChange" clearable v-model="searchForm.gangweileibie" placeholder="请选择岗位类别">
		    <el-option
