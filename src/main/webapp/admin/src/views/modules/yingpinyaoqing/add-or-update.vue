  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.gangweimingcheng" label="岗位名称" prop="gangweimingcheng">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="邀请时间" prop="yaoqingshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yaoqingshijian" label="邀请时间" prop="yaoqingshijian">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="邀请内容" prop="yaoqingneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yaoqingneirong" label="邀请内容" prop="yaoqingneirong">
                    <span>{{ruleForm.yaoqingneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    gangweimingchengChange () {
      this.$http({
        url: `follow/zhaopinxinxi/gangweimingcheng?columnValue=`+ this.ruleForm.gangweimingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.gangweileibie){
                this.ruleForm.gangweileibie = data.data.gangweileibie
              }
              if(data.data.xinzidaiyu){
                this.ruleForm.xinzidaiyu = data.data.xinzidaiyu
              }
        } else {
          this.$message.error(data.msg);
        }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yingpinyaoqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yingpinyaoqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
