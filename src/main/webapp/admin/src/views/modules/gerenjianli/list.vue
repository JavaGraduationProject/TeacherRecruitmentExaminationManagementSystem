<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('gerenjianli','邀请') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yingpinyaoqingCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'邀请':'' }}</el-button>
                <el-button v-if="isAuth('gerenjianli','邀请') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yingpinyaoqingCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'邀请':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('gerenjianli','邀请') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yingpinyaoqingCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'邀请':'' }}</el-button>
    ...
    <yingpinyaoqing-cross-add-or-update v-if="yingpinyaoqingCrossAddOrUpdateFlag" :parent="this" ref="yingpinyaoqingCrossaddOrUpdate"></yingpinyaoqing-cross-add-or-update>
...
import yingpinyaoqingCrossAddOrUpdate from "../yingpinyaoqing/add-or-update";
export default {
  data() {
    return {
      fenleiOptions: [],
      ...
      yingpinyaoqingCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    yingpinyaoqingCrossAddOrUpdate,
  },
  methods: {
    contentStyleChange() {
    ...
    yingpinyaoqingCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.yingpinyaoqingCrossAddOrUpdateFlag = true;
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.yingpinyaoqingCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.yingpinyaoqingCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
          this.$http({
